...
Route::group(['prefix' => 'v1', 'namespace' => 'Api',], function () {
    ...
    Route::resource(
        ...
        [
            'names' =>
            [
                'index' => 'api.departmentaccessories.index',
                'show' => 'api.departmentaccessories.show',
                'store' => 'api.departmentaccessories.store',
                'update' => 'api.departmentaccessories.update',
                'destroy' => 'api.departmentaccessories.destroy'
            ],
            'except' => ['create', 'edit'],
        ]
    ); // Departments Accessories resource
