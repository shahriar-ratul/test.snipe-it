        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
              ...
              <li{!! (Request::is('assign-accessories*') ? ' class="active"' : '') !!}>
                <a href="{{ route('assign-accessories.index') }}">
                  <i class="fa fa-keyboard-o"></i>
                  <span>{{ trans('general.department_accessories') }}</span>
                </a>
              </li>
              @endcan
            ...
            <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                     <li>
                        <a href="{{ route('reports.departmentaccessories') }}" {{ (Request::is('reports/departmentaccessories') ? ' class="active"' : '') }}>
